...
public class ActionToProduktionsinstallation implements ActionExecuteStateTransition {
	
	private final PatchPersistence repo;
	private final JenkinsPatchClient jenkinsPatchClient;
	
	public ActionToProduktionsinstallation (SimplePatchContainerBean patchContainer) {
