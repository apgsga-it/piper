...
public class ActionToInformatiktestinstallation implements ActionExecuteStateTransition {
	
	private final PatchPersistence repo;
	private final JenkinsPatchClient jenkinsPatchClient;
	
	public ActionToInformatiktestinstallation (SimplePatchContainerBean patchContainer) {
