...
public class PliConfig {
	...
	public ConfigObject configObject() {
		...
		properties.put("onclone.delete.artifact.dryrun", Boolean.valueOf(env.getProperty("onclone.delete.artifact.dryrun")));
		...
		properties.put("artifactory.patch.rpm.repo.name", env.getProperty("patchRepoName"));
